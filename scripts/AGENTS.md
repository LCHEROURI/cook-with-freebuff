...
| `codex-review-pr-gate.mjs` | Required PR check: skips Codex polling for low-risk docs/policy/tests-only PRs; scans high-risk PR findings, blocks open P0/P1, and certifies bot skips per the conventions below |
