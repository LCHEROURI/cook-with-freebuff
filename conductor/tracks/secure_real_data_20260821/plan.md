...
- [x] Task 3.1: Inventory quota-bearing routes and add contract tests proving App Check executes before model/provider work
...
- [x] Task 3.6: Document prerequisites, monitor observation, activation, rollback, and failure diagnosis
- [x] Task 3.7: Conductor - User Manual Verification 'App Check enforcement rollout'
...
- [x] Task 4.1: Add an authenticated real-data smoke covering create, read, update, owner isolation, and cleanup without exposing secrets
- [x] Task 4.2: Run the full unit, contract, emulator, typecheck, lint, and production-build gates
