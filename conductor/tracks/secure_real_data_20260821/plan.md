...
- [ ] Task 2.1: Add a Cook With Freebuff emulator-rules harness with deterministic owner, second-user, and unauthenticated fixtures
- [ ] Task 2.2: Add failing rules tests for cross-user access, ownership transfer, and forbidden operations across every Cook With Freebuff collection
- [ ] Task 2.3: Tighten only the Cook With Freebuff clauses in the union ruleset while preserving non-Cook clauses byte-for-byte
