...
const RC_PARAMS: Record<GeminiModelRole, string> = {
  generation: 'recipe_generation_model',
  validation: 'recipe_validation_model',
  conversation: 'conversation_model',
  vision: 'vision_model',
  'live-voice': 'live_voice_model',
};
